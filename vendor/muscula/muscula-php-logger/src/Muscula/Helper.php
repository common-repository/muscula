...
namespace Muscula {
	 ...
	 *
	 * Usage:
	 * 1. Call \Muscula\Helper::register();
	 * 2. Call M::debug($sql, 'db') or M::db($sql)
	 *
	...
	class Helper {
		...
		/**
		 * This method must be called to make class "M" available
		 ...
		 * You can access it like M::tagName($debugData, $additionalTags = null)
		 * @param string $tags
		 * @param $args
		 */
